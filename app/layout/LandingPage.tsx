  ...
  return (
    <div className="bg-gray-100">
      ...
      <header className="bg-muted py-48">
        <div className="container mx-auto text-center px-4">
          ...
          <p className="mt-4 text-lg md:text-xl">
            Your all-in-one app for tracking expenses, budgeting, and saving
            money.
          </p>
          <Link
            href="#signup"
      ...
      <main className="container mx-auto py-10 px-4">
        <section className="text-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-56">
        ...
        <section className="mt-10 text-center">
          ...
          <p className="mt-4 text-gray-700">
            With Savis, you can effortlessly manage your finances, make informed
